...
SHD_table = pd.read_csv("data/ShanghaiDogsTables/SHD_bins_MIMAG_report.csv")
...
rRNA_path = 'intermediate-outputs/07_ribosomal_genes/barrnap_fasta/'
...
output_file_path = 'intermediate-outputs/07_ribosomal_genes/16SrRNA_novel_sp.fa'
