...
# Remove comparisons with eachself
...
merged_tax = merged_tax[merged_tax['count_y'] > 300]
...
order_colors = {phylum: plt.cm.tab20(i) for i, phylum in enumerate(merged_tax_sorted['Phylum'].unique())}
