...
sequence_metadata_tsv = os.path.join(base_dir, "100AA_SmORFs_metadata.tsv")
...
with open(output_fasta, "w") as out_f:
    for idx, (seq, headers) in enumerate(sorted_sequences):
        new_id = lib.pad9("SHD1_SM.100AA", idx)
